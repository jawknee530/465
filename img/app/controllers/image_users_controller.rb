class ImageUsersController < ApplicationController
  ...
  def destroy
    @image_user.destroy
    respond_to do |format|
      format.html { redirect_to @image_user.image, notice: 'Image user was successfully destroyed.' }
  ...
  private
    ...
    def image_user_params
      params.require(:image_user).permit(:image_id, :user_id, :user_id, :image_id)
    end
end
