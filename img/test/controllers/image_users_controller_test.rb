...
class ImageUsersControllerTest < ActionController::TestCase
  ...
  test "should create image_user" do
    assert_difference('ImageUser.count') do
      post :create, image_user: { image_id: @image_user.image_id, image_id: @image_user.image_id, user_id: @image_user.user_id, user_id: @image_user.user_id }
    end
  ...
  test "should update image_user" do
    patch :update, id: @image_user, image_user: { image_id: @image_user.image_id, image_id: @image_user.image_id, user_id: @image_user.user_id, user_id: @image_user.user_id }
    assert_redirected_to image_user_path(assigns(:image_user))
  end
